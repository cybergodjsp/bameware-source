...
#define ORANGE CColor(255,100,75)
...
public:
	                       ...
	                       int alpha = 255)
	{
		...
		if (h < 1.f)
			return CColor(static_cast<int>(brightness * 255), static_cast<int>(t * 255), static_cast<int>(p * 255), alpha);
		else if (h < 2.f)
			return CColor(static_cast<int>(q * 255), static_cast<int>(brightness * 255), static_cast<int>(p * 255), alpha);
		else if (h < 3.f)
			return CColor(static_cast<int>(p * 255), static_cast<int>(brightness * 255), static_cast<int>(t * 255), alpha);
		else if (h < 4)
			return CColor(static_cast<int>(p * 255), static_cast<int>(q * 255), static_cast<int>(brightness * 255), alpha);
		else if (h < 5)
			return CColor(static_cast<int>(t * 255), static_cast<int>(p * 255), static_cast<int>(brightness * 255), alpha);
		else
			return CColor(static_cast<int>(brightness * 255), static_cast<int>(p * 255), static_cast<int>(q * 255), alpha);
	}
