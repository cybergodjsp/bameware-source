...
namespace SDK
{
	...
	public:
		void* operator new(size_t iAllocSize)
		{
			...
			return VMT::GetVFunction<oAllocKeyValuesMemory>(pKeyValuesSystem, 1)(pKeyValuesSystem, iAllocSize);
		}
		...
		void operator delete(void* pMem)
		{
			...
			VMT::GetVFunction<oFreeKeyValuesMemory>(pKeyValuesSystem, 2)(pKeyValuesSystem, pMem);
		}
